"""
PresenceMonitor — optional webcam presence detection ("welcome back").
...
class PresenceMonitor:
    ...
    def _open(self) -> bool:
        try:
            ...
            self._cap, _backend = open_camera_capture(cd.resolve())
                ...
                if seen:
                    ...
                    if not self._present:
                        ...
                        if now - self._last_greet > self.ABSENCE_GREET_GAP:
                            ...
                            self.bus.speak_request.emit("Welcome back.")
